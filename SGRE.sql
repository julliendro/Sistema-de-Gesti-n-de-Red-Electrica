...
INSERT INTO Usuario (nombre, apellido, direccion, telefono, fechaRegistro, Permisos_idPermisos) VALUES
('Laura', 'García', 'Av. San Martín 123', '3874112233', '2024-01-15', 1), -- idUsuario 1 (Cliente)
('Juan', 'Pérez', 'Calle 10 Nro 45', '3875445566', '2024-02-20', 1),   -- idUsuario 2 (Cliente)
('Carlos', 'López', 'Oficina Central Piso 3', '3875778899', '2023-11-01', 2), -- idUsuario 3 (Operario)
('Ana', 'Rodríguez', 'Sede Principal', '3873990011', '2023-10-01', 3);   -- idUsuario 4 (Administrador)


INSERT INTO Cliente (idCliente, NIS, nombreUsuario, correoElectronico, contraseña) VALUES
(1, '789012345', 'lauragarcia', 'laura.g@mail.com', 'hash_pass1'),
(2, '901234567', 'juanperez', 'juan.p@mail.com', 'hash_pass2');


INSERT INTO Operario (idOperario, idUniversal, correoElectronico, contraseña, departamento) VALUES
(3, 'OP1001', 'carlos.l@empresa.com', 'hash_op1', 'Instalaciones'),
(4, 'ADM001', 'ana.r@empresa.com', 'hash_adm1', 'Sistemas');
