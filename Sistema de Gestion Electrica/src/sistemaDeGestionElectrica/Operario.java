...
public class Operario extends Usuario{
    ...
    public Operario(int idUsuario, String nombre, String apellido, String direccion, String telefono, String correoElectronico, String contraseña, Permisos permisos, String idUniversal, String departamento) {

        super(idUsuario, nombre, apellido, direccion, telefono, correoElectronico, contraseña, permisos);

        this.idOperario = idUsuario; // <--- CORRECCIÓN: Asignación del ID
